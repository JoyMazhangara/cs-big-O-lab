...
// ANSWER:
let arr = []
console.log(arr[3]) //this solution has a time complexity of O(1) because it involves array indexing
...
// 14) You are challenged to find the squared value of each number in an array. 
//This is not the best solution, but it is what you come up with anyway...
...
// ANSWER:
let answers = numbers.map((num) => {
  return num * num
})

// 15) Here are two functions that you came up with to count how many of each letter is in a given string
// and return an object with the individual counts: 
...
// ANSWER: 
"The first function goes through the string and adds a count to the appropriate value in the letters object, the second function loops through the string adding new counts"